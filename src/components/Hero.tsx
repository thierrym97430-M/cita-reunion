...
export default function Hero({ particleNetwork, heroDevices }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen bg-ink overflow-hidden flex flex-col justify-center px-10 pt-[120px] pb-20 max-sm:px-5" id="accueil">
      ...
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background: "radial-gradient(circle, #1C2B4A 0%, transparent 70%)",
      ...
      <div className="relative z-[2] max-w-[1180px] mx-auto w-full">
        ...
        <motion.div
          ...
          className="hero-badge inline-flex items-center gap-2 px-3.5 py-1.5 pl-2 bg-white/[.07] border border-white/[.12] rounded-full mb-8"
        >
          <div
        ...
        <motion.h1
          ...
          className="font-heading font-extrabold text-[clamp(52px,7.5vw,96px)] leading-[.95] tracking-[-2px] text-white mb-9"
        >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-12 items-end max-md:grid-cols-1 max-md:gap-10"
        >
          ...
          <div className="flex flex-col gap-4 items-end max-md:items-start">
            <div className="flex gap-2.5 flex-wrap justify-end max-md:justify-start">
              <a
                href="#contact"
                className="hero-btn-primary inline-flex items-center gap-2 bg-red text-white no-underline px-[30px] py-[15px] rounded-xl font-heading text-[15px] font-bold transition-all hover:bg-red-h hover:-translate-y-0.5 hover:shadow-[0_14px_36px_rgba(200,16,46,.4)]"
              >
                Devis gratuit →
              </a>
              <a
                href="tel:0262948021"
                className="hero-btn-secondary inline-flex items-center gap-[7px] bg-white/[.07] text-white/70 no-underline px-6 py-3.5 rounded-xl font-heading text-[15px] font-medium border border-white/[.12] transition-all hover:bg-white/[.12] hover:text-white hover:border-white/[.22]"
              >
                📞 02 62 94 80 21
              </a>
            </div>
